    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{ Route::currentRouteName() ==  'dashboard.job-applications.index' ? 'active' : ''}}" href="{{ route('dashboard.job-applications.index') }}" role="button">
                        <i class="ri-survey-line"></i> <span>@lang('dashboard.job-applications')</span>
                    </a>
                </li>
                <li class="nav-item">
